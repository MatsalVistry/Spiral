...
const getScriptRecordings = async(_, { userid, title }) => {
    ...
    const query = "SELECT r.recordingid, s.scriptid, r.time_saved, r.title FROM recordings as r INNER JOIN scripts as s ON s.scriptid=r.scriptid WHERE s.userid = $1 AND s.title = $2";
